...
**Celem laboratorium jest opanowanie systemu kontroli wersji Git, platformy GitHub (zdalne repozytoria, GitHub Issues, GitHub Actions), stworzenie środowiska programistycznego dla wybranej technologii i dokumentacja wykonanej pracy za pomocą Markdown.**
...
[Dokumentacja Django](https://docs.djangoproject.com/en/6.0/)
